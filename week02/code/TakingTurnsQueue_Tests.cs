...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: (Expected:<Bob>. Actual:<Sue>) the first person in the queue becomes the last as new people is added
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: a person with infinite turns(0) is not enqueued into the queue once they have been dequeued
    ...
    // Defect(s) Found: a person with infinite turns(negative number) is not enqueued into the queue once they have been dequeued
